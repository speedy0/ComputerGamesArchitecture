...
{
    class ControlsState : StateManager
    {
        #region Properties
        Texture2D texture;
        #endregion
        ...
        #region Constructor
        public ControlsState(Game1 g, ContentManager cm, GraphicsDevice gd) : base(g, cm, gd)
        {
            texture = content.Load<Texture2D>("Graphics\\Background\\ControlsBG");
        }
        #endregion
